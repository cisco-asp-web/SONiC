...
- [Underlay BGP — Extensive Config \& Verification Reference](#underlay-bgp--extensive-config--verification-reference)
  - [3-Leaf / 1-Spine](#3-leaf--1-spine)
  - [Table of Contents](#table-of-contents)
  - [Device Addressing](#device-addressing)
    - [Spine4 Interface Map](#spine4-interface-map)
  - [Step 1 — Split-Unified Routing Configuration Mode](#step-1--split-unified-routing-configuration-mode)
  - [Step 2 — Interface IPs](#step-2--interface-ips)
    - [Verification — show ip interfaces](#verification--show-ip-interfaces)
  - [Step 3 — Underlay BGP](#step-3--underlay-bgp)
  - [Step 4 — Extensive Verification](#step-4--extensive-verification)
    ...
    - [4.7 Route Programming \& Nexthop Resolution — Kernel, APP\_DB, and ASIC](#47-route-programming--nexthop-resolution--kernel-app_db-and-asic)
      - [Linux Kernel Route Table](#linux-kernel-route-table)
      - [Linux ARP / Neighbor Table](#linux-arp--neighbor-table)
      - [SONiC APP\_DB (ROUTE\_TABLE and NEIGH\_TABLE)](#sonic-app_db-route_table-and-neigh_table)
      - [SONiC ASIC\_DB (SAI Object Store)](#sonic-asic_db-sai-object-store)
        - [List all route entries](#list-all-route-entries)
        - [Trace a single route through ASIC\_DB](#trace-a-single-route-through-asic_db)
      - [ASIC / NPU Verification (show platform npu)](#asic--npu-verification-show-platform-npu)
        - [NPU Route Table](#npu-route-table)
        - [NPU Prefix-to-Nexthop Mapping](#npu-prefix-to-nexthop-mapping)
        - [NPU Next-Hop Table](#npu-next-hop-table)
      - [Resolution Chain Summary](#resolution-chain-summary)
  ...
  - [Quick Reference — Verification Command Summary](#quick-reference--verification-command-summary)
...
## Step 1 — Split-Unified Routing Configuration Mode
